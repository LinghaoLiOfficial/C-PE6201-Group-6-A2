...
from agent_system.d4_harness import run_battery, read, code_check, import_reviews
...
class D4Tests(unittest.TestCase):
    ...
    def test_injected_failure_stays_in_denominator(self):
        from agent_system.runner import run_case
    ...
    def test_runner_does_not_read_grading_files(self):
        from agent_system.runner import run_case
        from agent_system.d4_harness import DATASET
